...
(b=[b]);for(c=0;c<b.length;c++){d=ds.object.get_method_signatures(b[c]);var h=ds.object.get_method_signatures(a);d=ds.array.diff(d,h);if(0<d.length){c=ds.object.get_methods(b[c]);for(b=0;b<d.length;b++)d[b]=c[d[b].substring(0,d[b].indexOf(ds.str.colon))];throw ds.str.sigNotImplementedIn+a.type+ds.str.newline+d.join(ds.str.newline);}}b=Object.keys(b)}var f=a.properties;-1!=a.constructor.toString().indexOf("function Object()")?a.constructor=function(){f&&ds.data.copy(f,this)}:(a._constructor=a.constructor,
a.constructor=function(){f&&ds.data.copy(f,this);this._constructor.apply(this,arguments)});a.constructor.prototype=a;b=e?new a.constructor:a.constructor;a.type&&ds.make.namespace(a.type,b);return b};ds.make["static"]["class"]=function(a){ds.make["class"](a,!0)};
