...
ds.data.copy=function(a,d,b,c){c||(c=!0);d||(d=a instanceof Array?[]:{});for(var e in a){var f=!0;b&&-1!=b.indexOf(e)&&(f=!1);f&&(c&&!d[e]||!c)&&(d[e]=typeof a[e]==ds.str.funct?a[e]:a[e]==a?a:ds.data.copy(a[e]))}return d};ds.make.namespace=function(a,d){var b=a.split(".");if(1==b.length)window[b[0]]=window[b[0]]||d;else{for(var c=window[b[0]]=window[b[0]]||{},e=1;e<b.length-1;e++)c[b[e]]=c[b[e]]||{},c=c[b[e]];c[b[e]]=c[b[e]]||d;return d}};
...
Array||(c=[c]);for(d=0;d<c.length;d++){b=ds.object.get_method_signatures(c[d]);var f=ds.object.get_method_signatures(a);b=ds.array.diff(b,f);if(0<b.length){d=ds.object.get_methods(c[d]);for(c=0;c<b.length;c++)b[c]=d[b[c].substring(0,b[c].indexOf(ds.str.colon))];throw ds.str.sigNotImplementedIn+a.type+ds.str.newline+b.join(ds.str.newline);}}c=Object.keys(c)}if(a.constructor&&"function"==typeof a.constructor)return-1!=a.constructor.toString().indexOf("function Object()")&&(a.constructor=function(){}),
a.constructor.prototype=a,ds.make.namespace(a.type,a.constructor),a.constructor};ds.make["enum"]=function(a){for(var d={},b=Object.keys(a),c=0;c<b.length;c++){var e=a[b[c]];d[b[c]]=e;d[e]=b[c]}return d};
